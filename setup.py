...
setup(
    ...
    url="https://github.com/flexrobotics/roboflex_realsense",
    ...
    ext_modules=[CMakeExtension('roboflex/realsense/roboflex_realsense_ext')],
    cmdclass=dict(build_ext=CMakeBuild),
    py_modules=['__init__'],
    packages=['roboflex.realsense'],
    package_dir={'roboflex.realsense': 'python'}
)
